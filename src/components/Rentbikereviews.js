...
const Rentbikereviews = () => {
  ...
  const sendId = async () => {
    try {
      const res = await fetch(`${URL}/sendReviewRentBikeId`, {
        method: "POST",
        headers: {
  ...
  const reviewBikeData = async () => {
    try {
      const res = await fetch(`${URL}/getRentBikeReviews`, {
        method: "GET",
      });
  ...
  const getallreviews = async () => {
    try {
      const res = await fetch(`${URL}/getallreviewsforselectedrentbike`, {
        method: "GET",
      });
  ...
  const submitReviews = async (e) => {
    ...
    const res = await fetch(`${URL}/postrentbikereviews`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
