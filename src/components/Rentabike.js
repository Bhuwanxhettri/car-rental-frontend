...
const Rentabike = () => {
  ...
  const allRentBikes = async () => {
    try {
      ...
      const res = await fetch(`${URL}/getRentBikeData`, {
        method: "GET",
        headers: {
          Authorization: `${token}`,
        },
  ...
  const proceedToCart = async (e) => {
    ...
    const res = await fetch(`${URL}/addrentcartocart`, {
      method: "POST",
      headers: {
  ...
  const searchTextBtn = async () => {
    const res = await fetch(`${URL}/searchRentBike`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const getSearchData = async () => {
    try {
      const res = await fetch(`${URL}/rentbikesearchCategory`, {
        method: "GET",
      });
